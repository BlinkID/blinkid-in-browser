...
class MyApp
{
    ...
    constructor( sdk )
    {
        ...
        this.scanBothSidesFlag = document.getElementById( "scan-both-sides" );
        this.scanFromFileInput = document.getElementById( "scan-from-file" );
        this.labelScanFromImage = document.getElementById( "showcase-scan-from-image-label" );

        // Register UI actions
        document.getElementById( "scan-from-camera" )
        ...
        document.getElementById( "scan-from-file" )
    ...
    async scanFromCamera()
    {
        ...
        document.getElementById( "view-scan-from-camera" ).classList.remove( "hidden" );
    ...
    async saveTemporaryResults( results )
    {
    ...
    {
        document.getElementById( "view-landing" ).classList.add( "hidden" );
        document.getElementById( "view-scan-from-file" ).classList.remove( "hidden" );
        ...
        const imageEl = document.getElementById( "scan-image" ); // Or `= document.createElement( "img" );`
        imageEl.src = URL.createObjectURL( file );
        await imageEl.decode();
        const imageFrame = BlinkIDSDK.captureFrame( imageEl );
    ...
    {
        document.getElementById( "view-landing" ).classList.remove( "hidden" );
        document.getElementById( "view-scan-from-camera" ).classList.add( "hidden" );
        document.getElementById( "view-scan-from-file" ).classList.add( "hidden" );
        document.getElementById( "view-results" ).classList.add( "hidden" );
        document.getElementById( "scan-from-file" ).value = "";
    }
    ...
    showResults( results )
    {
        ...
        document.querySelector( "#view-results textarea" ).value = JSON.stringify( safeResults, null, 2 );
    }

    removeImagesFromResults( results )
    {
        const safeResults = {};
