...
function main()
{
  ...
  let licenseKey = "";

  if (window.location.hostname === "blinkid.github.io")
  {
    licenseKey = "";
  }
...
async function startScan(sdk)
{
  ...
  const callbacks = {
    ...
    onFirstSideResult: () => console.log("Flip the document")
  };
