...
| `cameraExperienceStateDurations`       | --                                         | Configure camera experience state timeout durations                                                                                                         | `CameraExperienceStateDurations`                                                                                                                             | `null`      |
...
| `type`                                 | `type`                                     | Choose desired camera experience.  Each experience type must be implemented in this component.                                                              | `CameraExperience.Barcode \| CameraExperience.CardMultiSide \| CameraExperience.CardSingleSide \| CameraExperience.Passport \| CameraExperience.PaymentCard` | `undefined` |
