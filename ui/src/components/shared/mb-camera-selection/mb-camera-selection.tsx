...
export class MbCameraSelection {
  ...
  async setActiveCamera(cameraId: string) {
    const camera = this.cameraList.find(
      (el: CameraEntry) => el.details.deviceId === cameraId,
    );
  ...
  render() {
        ...
        content = (
          ...
          >
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M17.2559 5.24408C17.5813 5.56951 17.5813 6.09715 17.2559 6.42259L8.92257 14.7559C8.59713 15.0814 8.06949 15.0814 7.74406 14.7559L3.57739 10.5893C3.25195 10.2638 3.25195 9.73618 3.57739 9.41074C3.90283 9.08531 4.43047 9.08531 4.7559 9.41074L8.33331 12.9882L16.0774 5.24408C16.4028 4.91864 16.9305 4.91864 17.2559 5.24408Z"
              fill="#0062F2"
            />
          </svg>
        );
    ...
    return (
      <Host>
          ...
          <span class="icon">
            ...
            >
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M4.9107 6.91076C5.23614 6.58533 5.76378 6.58533 6.08922 6.91076L10.5 11.3215L14.9107 6.91076C15.2361 6.58533 15.7638 6.58533 16.0892 6.91076C16.4147 7.2362 16.4147 7.76384 16.0892 8.08928L11.0892 13.0893C10.7638 13.4147 10.2361 13.4147 9.9107 13.0893L4.9107 8.08928C4.58527 7.76384 4.58527 7.2362 4.9107 6.91076Z"
                fill="white"
              />
            </svg>
          </span>
        ...
        ></div>
        <div class={this.isListVisible ? "list visible" : "list"}>
          <ul>{cameraListElements}</ul>
        </div>
      </Host>
    );
  }
